...
import { capitalize, afgerond, slugify, lowercase, theweek } from '../common/common';
...
export function Sort (props) {
	...
	const selectedCategory = props.thecategories.find(({ name }) => slugify(name) === props.match.params.url);
		...
		<div className="container">
			...
			<div className="pr-box-right">
				...
				{props.thesorts.map((hit, index) => {
					...
					if (hit.category.name === selectedCategory.name)
					return (
